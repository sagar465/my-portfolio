    ...
    experience: [
        {
            ...
            achievements: [
                "Leading a team of 4 UI developers, overseeing task allocation, code reviews, and sprint planning to ensure timely delivery of high-quality features.",
                "Architecting and developing full stack web and mobile apps using Angular, React TS, Zustand, React Native, and Expo.",
                "Built and integrated Micro Frontends using Webpack 5 and Module Federation, enabling seamless dependency sharing across apps.",
                "Created a reusable Angular Survey Form library with JSON-configurable multi-step navigation—plug-and-play across projects.",
                "Implemented technician live tracking portal using Maplibre, AWS Here Maps, and Datadog for real-time monitoring and alerting.",
                "Converted web applications to mobile apps with full Android/iOS compatibility using React Native.",
                "Leveraged AI tools like Copilot, Supabase AI, Figma Make, WorkIk, and Replit to accelerate development and deliver stunning UI/UX.",
                "Delivered BDD automation using Cucumber, Selenium, and QAF frameworks for robust test coverage.",
                "Actively mentoring junior developers on frontend architecture, performance optimization, and design best practices.",
                "Tech Stack: Angular, React TS, Zustand, React Native, Expo, Java, Spring, MySQL, Maplibre, AWS, Datadog, Supabase AI, Figma Make, Selenium, Cucumber, QAF"
            ],
        },
        {
            ...
            achievements: [
                "Led backend and frontend teams in building secure, scalable microservices using Spring Boot and REST APIs.",
                "Architected Micro Frontend solutions using Webpack Module Federation, enabling modular deployments across banking portals.",
                "Streamlined CI/CD pipelines with DevOps tooling, reducing deployment time and increasing release frequency.",
                "Facilitated client workshops and delivered market-driven PoCs, bridging business needs with technical feasibility.",
                "Mentored junior engineers and fostered a culture of clean code, test coverage, and agile collaboration.",
                "Tech Stack: Java, Spring Boot, Webpack 5, Module Federation, REST APIs, CI/CD, DevOps, Accessibility, Agile"
            ],
        },
        {
